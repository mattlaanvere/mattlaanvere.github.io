package mattlaanvere.website.components.layouts
...
import mattlaanvere.website.components.sections.Footer
import mattlaanvere.website.components.sections.NavHeader
...
fun PageLayout(ctx: PageContext, content: @Composable ColumnScope.() -> Unit) {
    ...
    LaunchedEffect(data.title) {
        document.title = "Matt Laanvere - ${data.title}"
    }
