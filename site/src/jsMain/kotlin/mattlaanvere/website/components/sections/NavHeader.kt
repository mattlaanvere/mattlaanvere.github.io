package mattlaanvere.website.components.sections
...
import mattlaanvere.website.components.widgets.IconButton
import mattlaanvere.website.toSitePalette

val NavHeaderStyle = CssStyle.base {
    Modifier.fillMaxWidth().padding(leftRight = 1.5.cssRem, topBottom = 1.cssRem)
}

val NavTitleStyle = CssStyle.base {
    Modifier
        .fontSize(1.1.cssRem)
        .fontWeight(600)
...
fun NavHeader() {
    Row(NavHeaderStyle.toModifier(), verticalAlignment = Alignment.CenterVertically) {
        Link("/", variant = UndecoratedLinkVariant.then(UncoloredLinkVariant)) {
            SpanText("Matt Laanvere", NavTitleStyle.toModifier())
        }
